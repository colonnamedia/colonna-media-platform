                  ...
                  <div className="p-8">
                    ...
                    <div className="aspect-video overflow-hidden mb-6 border border-border">
                        <img
                          src={service.img}
                          alt={service.title}
                          className={`w-full h-full object-cover group-hover:scale-105 transition-transform duration-500 ${service.title === "Consulting" ? "object-[center_20%]" : service.title === "Content Creation" ? "object-[center_10%]" : "object-center"}`}
                        />
                      </div>
                    }
